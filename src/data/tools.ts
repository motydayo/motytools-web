...
export const TOOLS: Tool[] = [
  ...
  },
  {
    slug: 'genka-shokyaku',
    name: '減価償却 計算ツール',
    title: '建物の減価償却 計算｜木造・鉄骨・RCの耐用年数と毎年の償却費',
    description:
      'アパート・マンション・戸建の建物取得価額と構造・築年月から、定額法の減価償却費を毎年ぶん自動計算。中古で買った物件の耐用年数（簡便法）にも対応した無料ツールです。',
    short: '建物の取得価額と構造から毎年の減価償却費を計算。',
    category: 'money',
    keywords: [
      '減価償却 計算',
      '建物 減価償却',
...
export const APP_PROMOS: Record<string, AppPromo> = {
  ...
  loan: OOYA_NOTE,
  // 建物の減価償却を調べている人は、ほぼ確実に大家か、これから大家になる人
  'genka-shokyaku': OOYA_NOTE,
